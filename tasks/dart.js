...
gulp.task('minify', function(){
  return gulp.src('build/**/*.{html,css}', {dot:true})
    .pipe($.if('*.css', $.csso()))
...
// // TODO: fix this. its not working with pub build
...
gulp.task('clean', del.bind(null, ['web', 'build', '.tmp']));
...
// try { require('require-dir')(join(ROOT, 'app/tasks')); } catch (err) {}
